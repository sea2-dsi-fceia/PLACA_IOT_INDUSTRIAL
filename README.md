...
Relés de simple inversor optoaislados, con capacidad de manejo en 220V CA o 24V CC.  Salidas de Estado Sólido (5): Implementadas con TRIACs optoaislados (MOC3021 y BT136) para cargas de 220V CA.  Protección: Diodos de freewheeling (1N4007) en antiparalelo con las bobinas de los relés para proteger los transistores driver.

## Periféricos e InterfazPantalla OLED: 
Comandada por protocolo $I^{2}C$ para interfaz HMI local.  Almacenamiento: Memoria EEPROM para datos no volátiles.  Tiempo Real: Reloj calendario (RTC) con batería de backup para registro de eventos.  Indicadores: LED RGB y alarma sonora (buzzer) para monitoreo de estados.
